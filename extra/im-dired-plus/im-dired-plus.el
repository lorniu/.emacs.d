...
(defhydra hydra-dired-quick-sort (:hint nil :color steal :columns 3)
  ("n" (dired-quick-sort :name) "By Name")
  ("t" (dired-quick-sort :time) "By Time")
  ("r" (find-alternate-file default-directory) "Revert dired buffer")
  ("s" (dired-quick-sort :size) "By Size")
  ("e" (dired-quick-sort :ext)  "By Ext")
  ("g" (dired-quick-sort nil (* -1 dired-quick-sort-group-dir))
   (format "Group Dirs [%s]" (if (plusp dired-quick-sort-group-dir) "X" " ")))
  ("q" nil :hint t :color blue))
