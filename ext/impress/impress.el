...
(org-export-define-derived-backend 'impress-js 'html
  ...
  :menu-entry
  '(?i "Export to impress.js HTML"
       ((?I "As impress.js HTML buffer" org-impress-js-export-as-html)
        (?i "As impress.js HTML file" org-impress-js-export-to-html)
...
(defvar org-impress-js-slide-angles '(10 10 10 10)
...
(defcustom org-impress-js-default-trans '(200 0 0)
...
(defcustom org-impress-js-stylesheet "./css/impress-demo.css"
...
(defcustom org-impress-js-javascript "https://cdn.bootcss.com/impress.js/0.5.3/impress.js"
  ...
  (org-element-normalize-string
   (concat
    (let* ((props (org-impress-js--global-slide-plist info :impress-js-title))
      ...
      (format "<%s id=\"title\" class=\"%s\" %s>\n" org-html-container-element class attrs))
    ;; Document title.
    (let ((title (plist-get info :title)))
      (format "<h1>%s</h1>\n" (org-export-data (or title "") info)))
    (org-html--build-pre/postamble 'postamble info)
    (format "</%s>" org-html-container-element))))
                        ...
                        (concat
                         (and numberedp
                              (format
                               ...
                               level
                               (mapconcat #'number-to-string (org-export-get-headline-number headline info) ".")))
                         full-text)
                        level)
