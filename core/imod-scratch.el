;;; imod-scratch.el --- *scratch* -*- lexical-binding: t -*-
...
(transient-define-prefix im/transient-*scratch* ()
  [[("m"
...
(provide 'imod-scratch)

;;; imod-scratch.el ends here
