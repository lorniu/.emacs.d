;;; face-modeline.el --- Mode Line -*- lexical-binding: t -*-

;; https://gnu.org/software/emacs/manual/html_node/elisp/Mode-Line-Data.html

;;; Code:

(defvar im:mode-line-prev '((:eval (im:pin-window-format))))
(defvar im:mode-line-post '((ic/proxy (:eval im:proxy-format))))
...
(provide 'face-modeline)

;;; face-modeline.el ends here
