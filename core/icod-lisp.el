...
(defun im-lisp-indent-function (indent-point state)
  "Fix the silly indent of keyword lists."
    ...
    (cond
     ...
     (t
      (let ((function (buffer-substring (point)
            ...
            method)
        (setq method (or (function-get (intern-soft function) 'lisp-indent-function)
...
(add-hook 'emacs-lisp-mode-hook (lambda () (setq-local lisp-indent-function #'im-lisp-indent-function)))
