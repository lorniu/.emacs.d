...
(x nxml-mode
   ...
   (defun:hook nxml-mode-hook ()
     ...
     (add-hook 'which-func-functions 'ln:nxml-where t t)))
...
(defun ln:push-point-to-xref-marker-stack (&rest _r)
  (xref-push-marker-stack (point-marker)))

(dolist (func '(find-function citre-jump))
  (advice-add func :before 'ln:push-point-to-xref-marker-stack))
