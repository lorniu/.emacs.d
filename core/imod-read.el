...
(x pdf-tools
   ...
   :preface (defvar ln-pdf-tools-p IS-G)
   :if ln-pdf-tools-p
...
(defun ln/rotate-pdf-with-pdftk (&optional counterclockwise-p page)
...
(cl-defmethod ln:local-assist ((_ (eql 'nov-mode)))
  (ln/describe-major-mode-keymap))

(cl-defmethod ln:local-assist ((_ (eql 'pdf-view-mode)))
  (ln/describe-major-mode-keymap))
