...
(x sql/i
   ...
   :config
   (add-hook 'sql-interactive-mode-hook 'f/font-of-face-buffer-local)
...
(x sqlplus
   ...
   :config
   (ignore-errors
     (f/font-of-face 'sqlplus-table-head-face 'sqlplus-table-odd-rows-face 'sqlplus-table-even-rows-face)))
