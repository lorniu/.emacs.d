;;; idev-markdown.el --- Markdown -*- lexical-binding: t -*-
...
(transient-define-prefix im/transient-markdown-mode ()
  [:hide
   (lambda () t)
  ...
  (if (eq major-mode 'markdown-mode)
      (transient-setup 'im/transient-markdown-mode)
...
(provide 'idev-markdown)

;;; idev-markdown.el ends here
