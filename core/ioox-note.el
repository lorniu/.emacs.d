;;; ioox-note.el --- Note publishing -*- lexical-binding: t -*-
;;; Commentary:

;; After published or git pushed, you can:
;;
;;   (im/interactive-script "sync-published-notes-to-vps.sh") ; sync html
;;   (url-retrieve "https://vps/sys/pull-and-reload")         ; reload server
;;
