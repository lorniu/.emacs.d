;;; imoox-gtd.el --- GTD in Org -*- lexical-binding: t -*-
;;; Commentary:
;;; Code:
...
(setq org-log-into-drawer t
      ...
      org-default-scratch-file (org-default-file-expand "doodle.org")
...
(setq org-capture-templates
      `(("n" "Notes" entry (file ,org-default-notes-file) "* %U\n\n%i%?" :prepend t :empty-lines 1)
        ...
        ("d" "涂鸦簿" entry (file ,org-default-scratch-file) "* %U\n\n%i%?" :prepend t :empty-lines 1)))
