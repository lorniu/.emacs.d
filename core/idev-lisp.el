;;; idev-lisp.el --- lisp family -*- lexical-binding: t -*-
...
(x macrostep
   ...
   :init
   ;;(define-obsolete-variable-alias 'macrostep-mode-map 'macrostep-mode-keymap "2023")
   :config
...
(transient-define-prefix im/transient-debugger-mode ()
  ...
  (if (eq major-mode 'debugger-mode)
      (transient-setup 'im/transient-debugger-mode)
    (user-error "Sorry, but this is not debugger-mode")))

(provide 'idev-lisp)

;;; idev-lisp.el ends here
